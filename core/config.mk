...
ifneq ($(WITAQUA_BUILD),)
include vendor/witaqua/config/BoardConfigWitAqua.mk
endif
...
ifneq ($(WITAQUA_BUILD),)
ifneq ($(wildcard device/witaqua/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/witaqua/sepolicy/common/sepolicy.mk)
endif
endif
